...
The notebook is the project. Cells run top-to-bottom: imports → hyperparameters → load/encode data → train/test split → batching → model classes → **resume from checkpoint** → **training loop** → manual save → sample generation.
